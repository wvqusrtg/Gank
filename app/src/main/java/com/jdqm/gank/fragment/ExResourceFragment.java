 ...
 */
public class ExResourceFragment extends BaseFragment {

    private SlimAdapter mSlimAdapter;
    private List<GankEntry> mData = new ArrayList<>();

    public static ExResourceFragment newInstance() {
        
        Bundle args = new Bundle();
        
        ExResourceFragment fragment = new ExResourceFragment();
    ...
    public void initView(LayoutInflater inflater, View view) {
        ...
        mSlimAdapter = SlimAdapter.create()
                .register(R.layout.item_ios, new SlimInjector<GankEntry>() {
                    @Override
    ...
    private void loadData(boolean isLoadMore) {
        new GankService().getExResourceData(PAGE_SIZE, mCurrentPage)
